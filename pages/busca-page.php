						...
						<div class="col-md-9">
							...
							<div id="custom-search-input">
								<div class="input-group btn-group col-md-12" role="group">
									<form id="form-busca" class="input-group btn-group" method="post" action="./index.html">
										<input id"busca-digitada" name="busca-digitada" type="text" class="form-control input-lg" placeholder="Buscar" />
										<a class="btn-flat btn-lg waves-effect" href=""><i class="fa fa-search mr-1"></i></a>
									</form>
								</div>
							</div>
						</div>
			...
			<section>
                ...
                <div class="card-deck" style="margin-top: 2%;">
                    ...
                    <div class="row">
						...
						$busca="SELECT  autor, titulo, preco, imagem, qtd FROM LIVRO WHERE titulo=$buscas ORDER BY id desc";
